...
>((props, ref) => (
  <SelectPrimitive.ScrollUpButton
    ref={ref}
    className={SelectScrollButtonBase}
    {...props}
  >
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      position={position}
      className={cn(
        // z‑index elevado para estar por encima del overlay negro
        "z-dialog max-h-96 min-w-[8rem] overflow-hidden rounded-md border",
