...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-dialog min-w-[8rem] overflow-hidden rounded-md border",
...
const withIcon = "[&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0"
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(baseItem, withIcon, inset && "pl-8", className)}
    {...props}
  />
))
